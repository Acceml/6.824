...
func doMap(
	...
	var inPut = mapF(inFile, string(content))
	...
	for _, kv := range inPut {
		...
		if !ok {
			...
			fileName2files[fileName] = file
		}

		var currentFile = fileName2files[fileName]
		// 追加写json
	...
	// 关闭文件
	for fileName := range fileName2files {
		_ = fileName2files [ fileName ].Close()
	}
